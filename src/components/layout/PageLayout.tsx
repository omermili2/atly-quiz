...
const layoutVariants = {
  default: 'flex flex-col items-center p-2 md:p-8 text-center overflow-hidden',
...
export default function PageLayout({ 
  ...
  const heightClasses = variant === 'default' ? 'h-[100vh]' : '';
  const allClasses = `${baseClasses} ${variantClasses} ${heightClasses} ${className}`.trim();
