  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen px-4 py-8 bg-gradient-to-br from-[#2b2e7a] via-[#5a2d91] to-[#a259c6]">
      ...
      <div className="w-full max-w-md mx-auto">
        ...
        {/* CTA Button */}
        <button className="w-full bg-gradient-to-r from-[#ff7eb3] via-[#ff758c] to-[#ff7eb3] text-white font-bold py-4 rounded-full text-xl shadow-xl hover:scale-105 transition-transform duration-200 mb-4">
          START MY FREE TRIAL
        </button>
